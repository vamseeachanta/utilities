REM CALL python -m assetutilities .\test_data\visualization\visualization_polar_pltoly.yml
REM CALL python -m assetutilities .\test_data\visualization\visualization_polar_matplotlib.yml

REM Project Specific files
REM CALL python -m assetutilities .\test_data\visualization\visualization_polar_ini_step6.yml
REM CALL python -m assetutilities .\test_data\visualization\visualization_polar_normal_lay.yml
